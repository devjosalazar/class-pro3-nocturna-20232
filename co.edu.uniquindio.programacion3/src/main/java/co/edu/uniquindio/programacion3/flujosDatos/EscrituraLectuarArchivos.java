...
public class EscrituraLectuarArchivos {
...
//			FileReader fr=new FileReader("C://td//directorioPrueba//fichero1.txt");
	...
	private static void fileReaderYWriter_V2() {
		...
		/**
		Si ejecutamos el c�digo, no escribir� nada en pantalla pero si escribir� en el fichero, 
		la pregunta es �Porque? La respuesta es que  cuando se cierra el stream, es como si pinch�ramos en guardar
		de forma gr�fica, es decir, que si no cerramos el stream es como si el fichero estuviera vacio. 
		Tambi�n debemos tener en cuenta que esto se debe a que leemos y modificamos el mismo fichero en el mismo tiempo.**/
...
//			FileReader fr=new FileReader("C://td//directorioPrueba//fichero2.txt");
	...
	private static void fileReaderYWriter_V3() {
		...
		/**
		Desde java 7 tenemos una mejor forma de abrir y cerrar stream, ahorr�ndonos trabajo.
		Como vemos, en el try creamos los objetos que queremos manejar, separados con un ; 
		por objeto, con esta forma los streams se cierran autom�ticamente.
		**/
...
//	mismo ejemplo pero con m�todos
